...
CellTypeEnum <- list(
  ...
  permissible_values = list(
    ...
    "bone_marrow_cell" = list(description = "bone marrow cell", exact_mappings = c("EFO:0002092")),
    ...
    "glial_brain_cell" = list(description = "glial_brain_cell", exact_mappings = c("EFO:1001464")),
    hematopoietic = list(description = "hematopoietic cell", exact_mappings = c("EFO:0000988")),
    "immortal_cell_line" = list(description = "immortal cell line cell", exact_mappings = c("EFO:0000019")),
    neoplastic = list(description = "neoplastic_cell", exact_mappings = c("EFO:0001063")),
    "reproductive_system" = list(description = "reproductive system cell", exact_mappings = c("EFO:0002955")),
...
schema$enums$cell_type_enum <- CellTypeEnum
